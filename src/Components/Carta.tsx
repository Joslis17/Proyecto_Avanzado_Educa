...
function Carta({
  ...
  return (
    <div className='bg-white p-3 rounded-2xl shadow-lg shadow-gray-400 hover:scale-106 transition-scale duration-400'>
      ...
      <div className='align-center justify-center flex mt-10'>
          <button 
            ...
            font-semibold text-md bg-[#5c0202] hover:bg-[#940404] hover:scale-110 transition-background,scale,shadow 

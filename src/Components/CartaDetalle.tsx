...
function CartaDetalle({
  ...
  return (
    <div className='flex items-center justify-center fixed inset-0 z-50 text-white'>
        <div className='relative bg-[#0f172a] border  rounded-4xl shadow-xl shadow-gray-700 p-4 md:p-8 w-full max-w-5xl h-auto overflow-y-auto max-h-[95vh] '>
            
            <div className='flex flex-col lg:flex-row gap-4 lg:gap-8 items-center justify-center'>
                <div className='flex flex-col items-center w-full lg:w-1/3'>
                    <div
                        className='w-64 h-96 md:w-80 md:h-115 border border-red-500 rounded-3xl bg-center 
                        bg-cover shadow-2xl shadow-red-700'
                ...
                <div className='flex-1 w-full flex flex-col gap-4'>
                    <h1 className='text-red-600 fuente_terror text-4xl font-bold text-center
                    ...
                    <div className='grid grid-cols-3 gap-2 text-center justify-center items-center'>
                        <div className='flex items-center gap-2 text-xl'>
                            <span className="font-bold text-purple-600">Tipo:</span>
                            <span>{tipo || "No definido"}</span>
                        </div>
                        <div className='flex gap-5 text-xl justify-center items-center border-3 border-gray-400 rounded-xl p-1 h-15 w-90 shadow-md
                        hover:shadow-gray-400 transition-all duration-300'>
                            <div className='flex items-center border-3 border-purple-800 rounded-xl p-1 text-center shadow-md h-10 w-25 hover:scale-105 transition-all duration-300 hover:shadow-purple-400'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <p className="text-xl font-bold">Habilidades Especiales:</p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            {listaHabilidadesIds.length > 0 ? (
                                listaHabilidadesIds.map((habId, i) => (
                                    <div key={i} className='border-3 border-purple-700 rounded-xl p-2 text-center text-md shadow-lg hover:shadow-purple-400 transition-all duration-300'>
                                        {obtenerNombreHabilidad(habId)}
                                    </div>
                                ))
                            ) : (
                                <div className='col-span-3 border-3 border-dashed border-gray-300 rounded-lg p-2 text-center text-sm italic text-gray-500 hover:shadow-purple-400 transition-all duration-300'>
                    ...
                    <div className='flex flex-col gap-1'>
                        <p className="text-xl font-bold ">Link de Imagen:</p>
                        <div className='p-2 border-3 rounded-xl border-purple-700 text-sm h-12 overflow-y-auto break-all shadow-md hover:shadow-purple-400 transition-all duration-300'>
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <p className=" italic p-3 rounded-lg text-sm border-3 border-purple-700 
                        overflow-y-auto h-15 shadow-md hover:shadow-purple-400 transition-all duration-300">
                            {description}
                        </p>
                    </div>
                </div>
            ...
            <div className='flex gap-4 mt-2 w-full justify-center'>
                <button 
                    ...
                    className='border-2 rounded-[10px] border-gray-200 p-1 mx-2 my-1 cursor-pointer text-white h-12 w-25
                    font-semibold text-md bg-red-800 hover:bg-red-600 hover:scale-110 transition-all shadow-lg shadow-gray-700
                ...
                <button 
                    ...
                    className='border-2 rounded-[10px] border-gray-200 p-1 mx-2 my-1 cursor-pointer text-white h-12 w-25
                    font-semibold text-md bg-purple-900 hover:bg-purple-700 hover:scale-110 transition-all shadow-lg shadow-gray-700

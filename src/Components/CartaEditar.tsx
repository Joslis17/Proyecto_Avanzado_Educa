...
function CartaEditar({ cartaInicial, onSave, onCancel }: Props) {
  ...
  return (
    <div className='relative bg-[#0f172a] rounded-4xl border shadow-xl shadow-red-500 p-8 w-full max-w-5xl h-auto overflow-y-auto max-h-[95vh] text-white'>

      <h2 className='text-red-600 mb-5 fuente_terror text-4xl font-bold text-center drop-shadow-lg drop-shadow-red-400 [-webkit-text-stroke:1px_white]'>
                    Editar Personaje</h2>
      
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
        <div className='flex flex-col gap-6'>
          <div className='flex flex-row gap-2 items-center'>
            <label className="font-bold ml-1">Nombre:</label>
            <input className='border-3 border-purple-700 p-3 rounded-xl focus:border-purple-600 
            outline-none transition-all shadow-lg hover:shadow-purple-400 hover:scale-105 
            duration-300 h-full w-full' 
                   value={name} onChange={(e) => setName(e.target.value)} />
          </div>
          
          <div className='flex flex-row gap-2 items-center'>
            <label className="font-bold ml-1">Tipo de Entidad:</label>
            <input className='border-3 border-purple-700 p-3 rounded-xl focus:border-purple-600 
            outline-none transition-all shadow-lg hover:shadow-purple-400 hover:scale-105 
            duration-300 h-full w-full'  
          ...
          <div className='flex flex-col gap-2'>
            <label className="font-bold ml-1">URL de la Imagen:</label>
            <input className='border-3 border-purple-700 p-3 rounded-xl focus:border-purple-600 
            outline-none transition-all shadow-lg hover:shadow-purple-400 hover:scale-105 
            duration-300 h-full w-full' 
          ...
          <div className='grid grid-cols-3 gap-4 border-3 border-gray-700 rounded-2xl p-4 shadow-lg hover:shadow-gray-400'>
            <div className='flex flex-col gap-2'>
              <Swords size={40} className="mx-auto text-red-500" />
              <input type="number" className='border-3 border-purple-800 p-2 rounded-xl text-center
              shadow-lg hover:shadow-purple-400 hover:scale-105 transition-all duration-300
        ...
        <div className='flex flex-col gap-5'>
          <div className='p-5 border-3 border-gray-400 rounded-2xl shadow-lg hover:shadow-gray-700 transition-all
         '>
            <h3 className='text-center font-bold mb-4'>Habilidades Especiales:</h3>
      ...
      <div className='flex gap-4 mt-5 justify-center '>
        <button onClick={onCancel} className='px-10 py-3 border-2 border-white rounded-xl font-bold bg-red-800
        hover:bg-red-600 transition-all hover:scale-110 cursor-pointer shadow-lg shadow-gray-600 hover:shadow-red-600 duration-300'>
          Cancelar
        </button>
        <button onClick={manejarGuardar} className='bg-purple-900 border-2 border-white hover:bg-purple-700 
        font-bold py-2 px-10 rounded-xl transition-all duration-400 hover:scale-110 shadow-lg 
        hover:shadow-purple-500 cursor-pointer shadow-gray-700'>
          Guardar Cambios
        </button>
      </div>
    </div>
